...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("ProcessUpdate", "Stationery", FormMethod.Post, new { @id = "f1" }))
        
     {%>
     <%  Stationery s = (Stationery)ViewData["update"]; %>
     <div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all form-container">
					...
					<div style="margin-left:30%">
							...
							<li><%=Html.Hidden("ProductId",s.ProductId) %> </li>
							    <li>
							        ...
							        <div>
							            <input type="text" name="ProductName" id="ProductName" class="field text medium" value="<%=s.ProductName %>" tabindex="1" maxlength="50"/>
								...
								<li>
									...
									<div>
										<input type="text" name="Rate" id="Rate" class="field text medium" value="<%=s.Rate %>"  tabindex="2" />
									</div>
								</li>
              ...
              {%>
								...
								<li>
									...
									<div>
										<input type="text" name="Description" id="Description" class="field text medium" value="<%=s.Description %>" tabindex="9" />
									</div>
								</li>
       ...
       $(document).ready(function() {
        ...
        $(document).ready(function() {
            ...
            $("#ProductName").blur(function() {
                ...
                $.post("/Stationery/Check4", { ProductName: name },
